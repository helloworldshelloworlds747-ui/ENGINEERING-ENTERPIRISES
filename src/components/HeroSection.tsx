...
export const HeroSection: React.FC<HeroSectionProps> = ({ 
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-[#F5F6F3] text-[#0B1B2B] border-b border-[#E2E6EA]">
      {/* Background Subtle Mesh & Ambient Lighting */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_70%_at_50%_-10%,rgba(22,119,255,0.08),rgba(245,246,243,0.95))] z-10" />
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#F5F6F3]/50 to-[#F5F6F3] z-10" />
      
      {/* Subtle blueprint grid watermark */}
      <div 
        className="absolute inset-0 opacity-[0.035] bg-cover bg-center mix-blend-multiply scale-105 pointer-events-none"
        style={{
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 lg:pt-16 lg:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <motion.div 
              ...
              className="inline-flex relative group overflow-hidden items-center gap-2.5 px-4 py-2 rounded-full bg-white/90 backdrop-blur-md border border-[#1677FF]/30 text-[#0B1B2B] text-xs font-semibold shadow-md shadow-[#1677FF]/5 hover:shadow-lg hover:shadow-[#1677FF]/15 hover:border-[#1677FF]/60 transition-all duration-300 select-none cursor-default"
            >
              {/* Continuous Traveling Light Sweep / Laser Shimmer Animation */}
              <motion.div
                className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/80 via-[#1677FF]/15 to-transparent pointer-events-none"
                animate={{
                  translateX: ['-100%', '200%']
                }}
                transition={{
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#EBF3FF] border border-[#1677FF]/20 text-[#1677FF] font-bold text-[11px] uppercase tracking-wider">
                Since 1992
              </span>
            </motion.div>
            ...
            <p className="text-sm sm:text-base text-[#6B747C] max-w-2xl leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-sm text-[#0B1B2B]">
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-white border border-[#E2E6EA] shadow-2xs">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                <span className="font-medium text-xs sm:text-sm">PEC License # 20000 (Category C4)</span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-white border border-[#E2E6EA] shadow-2xs">
                <CheckCircle2 className="w-4 h-4 text-[#1677FF] shrink-0" />
                <span className="font-medium text-xs sm:text-sm">ISO 9001:2008 & OHSAS 18001 Certified</span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-white border border-[#E2E6EA] shadow-2xs">
                <CheckCircle2 className="w-4 h-4 text-amber-600 shrink-0" />
                <span className="font-medium text-xs sm:text-sm">Led by Carrier USA Awarded CEO</span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-white border border-[#E2E6EA] shadow-2xs">
                <CheckCircle2 className="w-4 h-4 text-rose-600 shrink-0" />
                <span className="font-medium text-xs sm:text-sm">NFPA Standards Fire Protection Systems</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 pt-4">
              <button
                ...
                className="w-full sm:w-auto min-h-[48px] px-6 py-3.5 rounded-xl bg-[#1677FF] hover:bg-[#0E65E5] active:bg-blue-700 text-white font-bold text-sm tracking-wide shadow-md shadow-[#1677FF]/25 hover:shadow-lg hover:shadow-[#1677FF]/35 transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto min-h-[48px] px-5 py-3.5 rounded-xl bg-white hover:bg-slate-50 active:bg-slate-100 text-[#0B1B2B] border border-[#E2E6EA] hover:border-[#1677FF] font-semibold text-sm transition-all flex items-center justify-center gap-2 cursor-pointer shadow-2xs active:scale-[0.98]"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl bg-white border border-[#E2E6EA] p-6 sm:p-7 shadow-xl shadow-[#0B1B2B]/5">
              
              {/* Highlight Badge */}
              <div className="flex items-center justify-between pb-4 border-b border-[#E2E6EA]">
                ...
                <span className="text-xs bg-[#EBF3FF] text-[#1677FF] px-3 py-1 rounded-full border border-[#1677FF]/20 font-bold">
                  Since 1992
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3.5 my-5">
                <button
                  ...
                  className="bg-[#F5F6F3] hover:bg-white p-4 rounded-2xl border border-[#E2E6EA] hover:border-[#1677FF] text-left transition-all cursor-pointer group shadow-2xs hover:shadow-md"
                >
                  ...
                  <div className="text-[11px] text-[#6B747C] mt-0.5">Up to 90% Bill Reduction ↗</div>
                </button>

                <button
                  type="button"
                  onClick={() => scrollToSection('products')}
                  className="bg-[#F5F6F3] hover:bg-white p-4 rounded-2xl border border-[#E2E6EA] hover:border-rose-400 text-left transition-all cursor-pointer group shadow-2xs hover:shadow-md"
                >
                  ...
                  <div className="text-[11px] text-[#6B747C] mt-0.5">NFPA 291 & 13 Certified ↗</div>
                </button>
                ...
                >
                  ...
                  <div className="text-[11px] text-[#6B747C] mt-0.5">LT, ATS/AMF & PFI ↗</div>
                </button>
                ...
                <button
                  ...
                  className="bg-[#F5F6F3] hover:bg-white p-4 rounded-2xl border border-[#E2E6EA] hover:border-amber-400 text-left transition-all cursor-pointer group shadow-2xs hover:shadow-md"
                >
                  ...
                  <div className="text-[11px] text-[#6B747C] mt-0.5">License # 20000 ↗</div>
                </button>
              </div>
              ...
              <div 
                onClick={onOpenChat}
                className="mt-3 p-3.5 rounded-2xl bg-[#0B1B2B] text-white border border-slate-700/60 flex items-center justify-between cursor-pointer hover:border-[#1677FF] transition-all group shadow-md"
              >
        ...
        {/* Bottom Metrics Bar */}
        <div className="mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-[#E2E6EA] grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5">
          {ACHIEVEMENTS.map((item, idx) => (
            <div 
              key={idx} 
              className="bg-white rounded-2xl p-3.5 sm:p-5 border border-[#E2E6EA] text-center hover:border-[#1677FF] transition-all shadow-2xs hover:shadow-md group"
            >
              ...
              <div className="text-[10px] sm:text-[11px] text-[#6B747C] mt-0.5 sm:mt-1 line-clamp-1">
                {item.description}
              </div>
            </div>
          ))}
