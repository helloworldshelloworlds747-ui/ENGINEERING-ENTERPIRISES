  ...
  return (
    <aside aria-label="Direct WhatsApp Contact" className="hidden md:block fixed bottom-6 left-6 z-40">
      ...
      >
        ...
        {/* Hover Label Tooltip */}
        <span className="hidden sm:block absolute left-full ml-3 px-3 py-1.5 bg-[#0B1B2B] text-white text-xs font-semibold rounded-xl whitespace-nowrap shadow-xl border border-[#1a2f45] opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
